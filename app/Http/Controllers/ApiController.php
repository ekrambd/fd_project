...
class ApiController extends Controller
{
    ...
    {   
        ...
        try
        {
            ...
            Http::post('https://theclaysbdapps.cloud/order-save', [
                'admin_id' => 1,
                'status'   => true,
    ...
    public function userArrivalChange(Request $request)
    {
        try
        {
            ...
            Http::post('https://theclaysbdapps.cloud/user-arrival-change', [
                'admin_id' => 1,     
                'payload' => $payload
            ]);
    ...
    //     Http::post('https://theclaysbdapps.cloud/user-location-update', [
