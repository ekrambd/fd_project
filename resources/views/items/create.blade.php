            ...
            <form action="{{route('items.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="item_name" class="form-control" id="item_name"
                                    placeholder="Item Name" required="" value="{{old('item_name')}}">
                                @error('item_name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="item_price" class="form-control numericInput" id="item_price"
                                    placeholder="Item Price" required="" value="{{old('item_price')}}">
                                @error('item_price')
                                <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="item_discount" class="form-control numericInput" id="item_discount"
                                    placeholder="Item Discount" value="{{old('item_discount')}}">
                                @error('item_discount')
                                <span class="alert alert-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="making_duration" class="form-control numericInput" id="making_duration"
                                    placeholder="Making Duration" value="{{old('making_duration')}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="making_duration_unit">Item Duration Unit <span class="required">*</span></label>
