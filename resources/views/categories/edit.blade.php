                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="category_name" class="form-control" id="category_name"
                                    placeholder="Category Name" required="" value="{{old('category_name',$category->category_name)}}">
                                @error('category_name')
                        ...
                        <div class="col-md-12 d-none">
                          <div class="form-group">
                            ...
                            <input name="image" type="file" id="image" accept="image/*" class="dropify" data-height="200" data-default-file="{{URL::to($category->image)}}"/>
                            @error('image')
                            <span class="alert alert-danger">{{ $message }}</span>
                            @enderror
                          </div>
